    ...
    <div class="circle-clipper right">
      <div class="circle"></div>
				...
				<div class="col-lg-8 mx-auto ">
					...
					<h4 class="card-header primary-color text-white">When did this happen?</h4>
					<div class="card-body">
		<form action="">
<div class="md-form">
  ...
  <label for="input-limited-range">Time</label>
					...
					<div class="card mb-3"  style="display: none">
					<h4 class="card-header primary-color text-white">Where did this happen?</h4>
  ...
  <option>Artifical Lighting</option>
					...
					<div class="card mb-3"  style="display: none"> 
					<h4 class="card-header primary-color text-white">Describe the Event and What Could have happened</h4>
					<form class="card-body">
...
<div class="md-form amber-textarea active-amber-textarea">
  ...
  <label for="details">Required</label>
					...
					<div class="card mb-3"  style="display: none">
					<h4 class="card-header primary-color text-white">What were you able to do about it?</h4>
					<form class="card-body">
...
<div class="md-form amber-textarea active-amber-textarea">
  ...
  <label>
    ...
    <span class="lever"></span> Yes
					...
					<div class="card mb-3"  style="display: none">
					<h4 class="card-header primary-color text-white">Further information</h4>
					<form class="card-body">
...
var prevented = false;
		...
		$.post('createOccurance', {'Date' : datetime, 'Where' : where, 'Details' : details, 'Actions' : actions, Weather:Weather, Lighting_Conditions:Lighting_Conditions, 'Prevented' : prevented,Cords:Cords, 'Member_Of_Public':Member_Of_Public, 'Name': name, 'Employer': employer, 'Email': email, 'Occurance': 1, 'Site': site,Passed_To:Passed_To }).done(function(result){
			console.log(result);
            ...
            for (var i = 0; i < files.length; i++) {
                (function (file) {
					...
					$.post('SendOccuranceEmail', {'Date' : datetime, 'Where' : where, 'Details' : details, 'Actions' : actions, 'Prevented' : prevented, 'Name': name, 'Employer': employer, 'Email': email, 'Occurance': 1, 'mode': 3, 'LogID': LogID, 'Site': site }).done(function(result){
				setTimeout(function() {
    dialog.modal('hide');	
    ...
    callback: function () {
        window.location.replace('observations?id={{$ID}}')
								 ...
								 $.post('SendOccuranceEmail', {'Date' : datetime, 'Where' : where, 'Details' : details, 'Actions' : actions, 'Prevented' : prevented, 'Name': name, 'Employer': employer, 'Email': email, 'Occurance': 1, 'mode': 4, 'Site': site }).done(function(result){
			setTimeout(function() {
    dialog.modal('hide');	
