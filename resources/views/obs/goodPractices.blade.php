...
console.log('Just set stuff:', context)
 ...
 var prevented = true;
		...
		$.post('createOccurance', {'Date' : datetime, 'Where' : where, 'Details' : details, 'Actions' : actions, 'Prevented' : prevented,Cords:Cords ,  Weather:Weather, Lighting_Conditions:Lighting_Conditions, Member_Of_Public:Member_Of_Public, 'Name': name, 'Employer': employer, 'Email': email, 'Occurance': 2, 'Site': site, Passed_To: Passed_To }).done(function(result){
			console.log(result);
            ...
            for (var i = 0; i < files.length; i++) {
                (function (file) {
					...
					$.post('SendOccuranceEmail', {'Date' : datetime, 'Where' : where, 'Details' : details, 'Actions' : actions, 'Prevented' : prevented, 'Name': name, 'Employer': employer, 'Email': email, 'Occurance': 2, 'mode': 3, 'LogID': LogID, 'Site': site }).done(function(result){
			console.log(result);
						dialog.modal('hide');	
    ...
    callback: function () {
        window.location.replace('observations?id={{$ID}}')
								 ...
								 $.post('SendOccuranceEmail', {'Date' : datetime, 'Where' : where, 'Details' : details, 'Actions' : actions, 'Prevented' : prevented, 'Name': name, 'Employer': employer, 'Email': email, 'Occurance': 2, 'mode': 4, 'Site': site }).done(function(result){
			console.log(result);
						dialog.modal('hide');	
